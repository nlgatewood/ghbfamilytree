...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_000000005bea3862000000004ac6cb71(
...
class phpbbtemplatetwiglexer_000000005bea3862000000004ac6cb71 extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder5a936dbf8ce19751604384 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5a936dbf8ce1d502983527 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5a936dbf8ce0c294667793 = array(
    ...
    {
        $this->initializer5a936dbf8ce1d502983527 && ($this->initializer5a936dbf8ce1d502983527->__invoke($valueHolder5a936dbf8ce19751604384, $this, 'set_environment', array('env' => $env), $this->initializer5a936dbf8ce1d502983527) || 1) && $this->valueHolder5a936dbf8ce19751604384 = $valueHolder5a936dbf8ce19751604384;

        return $this->valueHolder5a936dbf8ce19751604384->set_environment($env);
    }
    ...
    {
        $this->initializer5a936dbf8ce1d502983527 && ($this->initializer5a936dbf8ce1d502983527->__invoke($valueHolder5a936dbf8ce19751604384, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer5a936dbf8ce1d502983527) || 1) && $this->valueHolder5a936dbf8ce19751604384 = $valueHolder5a936dbf8ce19751604384;

        return $this->valueHolder5a936dbf8ce19751604384->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer5a936dbf8ce1d502983527 && ($this->initializer5a936dbf8ce1d502983527->__invoke($valueHolder5a936dbf8ce19751604384, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer5a936dbf8ce1d502983527) || 1) && $this->valueHolder5a936dbf8ce19751604384 = $valueHolder5a936dbf8ce19751604384;

        return $this->valueHolder5a936dbf8ce19751604384->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer5a936dbf8ce1d502983527 = $initializer;
    }
    ...
    {
        $this->initializer5a936dbf8ce1d502983527 && ($this->initializer5a936dbf8ce1d502983527->__invoke($valueHolder5a936dbf8ce19751604384, $this, '__get', array('name' => $name), $this->initializer5a936dbf8ce1d502983527) || 1) && $this->valueHolder5a936dbf8ce19751604384 = $valueHolder5a936dbf8ce19751604384;

        if (isset(self::$publicProperties5a936dbf8ce0c294667793[$name])) {
            return $this->valueHolder5a936dbf8ce19751604384->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5a936dbf8ce19751604384;
    ...
    {
        $this->initializer5a936dbf8ce1d502983527 && ($this->initializer5a936dbf8ce1d502983527->__invoke($valueHolder5a936dbf8ce19751604384, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5a936dbf8ce1d502983527) || 1) && $this->valueHolder5a936dbf8ce19751604384 = $valueHolder5a936dbf8ce19751604384;
    ...
    {
        $this->initializer5a936dbf8ce1d502983527 && ($this->initializer5a936dbf8ce1d502983527->__invoke($valueHolder5a936dbf8ce19751604384, $this, '__isset', array('name' => $name), $this->initializer5a936dbf8ce1d502983527) || 1) && $this->valueHolder5a936dbf8ce19751604384 = $valueHolder5a936dbf8ce19751604384;
    ...
    {
        $this->initializer5a936dbf8ce1d502983527 && ($this->initializer5a936dbf8ce1d502983527->__invoke($valueHolder5a936dbf8ce19751604384, $this, '__unset', array('name' => $name), $this->initializer5a936dbf8ce1d502983527) || 1) && $this->valueHolder5a936dbf8ce19751604384 = $valueHolder5a936dbf8ce19751604384;
    ...
    {
        $this->initializer5a936dbf8ce1d502983527 && ($this->initializer5a936dbf8ce1d502983527->__invoke($valueHolder5a936dbf8ce19751604384, $this, '__clone', array(), $this->initializer5a936dbf8ce1d502983527) || 1) && $this->valueHolder5a936dbf8ce19751604384 = $valueHolder5a936dbf8ce19751604384;

        $this->valueHolder5a936dbf8ce19751604384 = clone $this->valueHolder5a936dbf8ce19751604384;
    }

    public function __sleep()
    {
        $this->initializer5a936dbf8ce1d502983527 && ($this->initializer5a936dbf8ce1d502983527->__invoke($valueHolder5a936dbf8ce19751604384, $this, '__sleep', array(), $this->initializer5a936dbf8ce1d502983527) || 1) && $this->valueHolder5a936dbf8ce19751604384 = $valueHolder5a936dbf8ce19751604384;

        return array('valueHolder5a936dbf8ce19751604384');
    }
    ...
    {
        return $this->initializer5a936dbf8ce1d502983527;
    }
    ...
    {
        return $this->initializer5a936dbf8ce1d502983527 && ($this->initializer5a936dbf8ce1d502983527->__invoke($valueHolder5a936dbf8ce19751604384, $this, 'initializeProxy', array(), $this->initializer5a936dbf8ce1d502983527) || 1) && $this->valueHolder5a936dbf8ce19751604384 = $valueHolder5a936dbf8ce19751604384;
    }
    ...
    {
        return null !== $this->valueHolder5a936dbf8ce19751604384;
    }
    ...
    {
        return $this->valueHolder5a936dbf8ce19751604384;
    }
