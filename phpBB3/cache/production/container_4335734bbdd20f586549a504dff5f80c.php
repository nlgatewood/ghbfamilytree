...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_000000007f362af1000000007fffbecd(
...
class phpbbtemplatetwiglexer_000000007f362af1000000007fffbecd extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder5a93250f73659896709034 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5a93250f7365d573560589 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5a93250f7364d634608860 = array(
    ...
    {
        $this->initializer5a93250f7365d573560589 && ($this->initializer5a93250f7365d573560589->__invoke($valueHolder5a93250f73659896709034, $this, 'set_environment', array('env' => $env), $this->initializer5a93250f7365d573560589) || 1) && $this->valueHolder5a93250f73659896709034 = $valueHolder5a93250f73659896709034;

        return $this->valueHolder5a93250f73659896709034->set_environment($env);
    }
    ...
    {
        $this->initializer5a93250f7365d573560589 && ($this->initializer5a93250f7365d573560589->__invoke($valueHolder5a93250f73659896709034, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer5a93250f7365d573560589) || 1) && $this->valueHolder5a93250f73659896709034 = $valueHolder5a93250f73659896709034;

        return $this->valueHolder5a93250f73659896709034->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer5a93250f7365d573560589 && ($this->initializer5a93250f7365d573560589->__invoke($valueHolder5a93250f73659896709034, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer5a93250f7365d573560589) || 1) && $this->valueHolder5a93250f73659896709034 = $valueHolder5a93250f73659896709034;

        return $this->valueHolder5a93250f73659896709034->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer5a93250f7365d573560589 = $initializer;
    }
    ...
    {
        $this->initializer5a93250f7365d573560589 && ($this->initializer5a93250f7365d573560589->__invoke($valueHolder5a93250f73659896709034, $this, '__get', array('name' => $name), $this->initializer5a93250f7365d573560589) || 1) && $this->valueHolder5a93250f73659896709034 = $valueHolder5a93250f73659896709034;

        if (isset(self::$publicProperties5a93250f7364d634608860[$name])) {
            return $this->valueHolder5a93250f73659896709034->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5a93250f73659896709034;
    ...
    {
        $this->initializer5a93250f7365d573560589 && ($this->initializer5a93250f7365d573560589->__invoke($valueHolder5a93250f73659896709034, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5a93250f7365d573560589) || 1) && $this->valueHolder5a93250f73659896709034 = $valueHolder5a93250f73659896709034;
    ...
    {
        $this->initializer5a93250f7365d573560589 && ($this->initializer5a93250f7365d573560589->__invoke($valueHolder5a93250f73659896709034, $this, '__isset', array('name' => $name), $this->initializer5a93250f7365d573560589) || 1) && $this->valueHolder5a93250f73659896709034 = $valueHolder5a93250f73659896709034;
    ...
    {
        $this->initializer5a93250f7365d573560589 && ($this->initializer5a93250f7365d573560589->__invoke($valueHolder5a93250f73659896709034, $this, '__unset', array('name' => $name), $this->initializer5a93250f7365d573560589) || 1) && $this->valueHolder5a93250f73659896709034 = $valueHolder5a93250f73659896709034;
    ...
    {
        $this->initializer5a93250f7365d573560589 && ($this->initializer5a93250f7365d573560589->__invoke($valueHolder5a93250f73659896709034, $this, '__clone', array(), $this->initializer5a93250f7365d573560589) || 1) && $this->valueHolder5a93250f73659896709034 = $valueHolder5a93250f73659896709034;

        $this->valueHolder5a93250f73659896709034 = clone $this->valueHolder5a93250f73659896709034;
    }

    public function __sleep()
    {
        $this->initializer5a93250f7365d573560589 && ($this->initializer5a93250f7365d573560589->__invoke($valueHolder5a93250f73659896709034, $this, '__sleep', array(), $this->initializer5a93250f7365d573560589) || 1) && $this->valueHolder5a93250f73659896709034 = $valueHolder5a93250f73659896709034;

        return array('valueHolder5a93250f73659896709034');
    }
    ...
    {
        return $this->initializer5a93250f7365d573560589;
    }
    ...
    {
        return $this->initializer5a93250f7365d573560589 && ($this->initializer5a93250f7365d573560589->__invoke($valueHolder5a93250f73659896709034, $this, 'initializeProxy', array(), $this->initializer5a93250f7365d573560589) || 1) && $this->valueHolder5a93250f73659896709034 = $valueHolder5a93250f73659896709034;
    }
    ...
    {
        return null !== $this->valueHolder5a93250f73659896709034;
    }
    ...
    {
        return $this->valueHolder5a93250f73659896709034;
    }
