...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_00000000647f280f00000000521ad6cd(
...
class phpbbtemplatetwiglexer_00000000647f280f00000000521ad6cd extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder5a936d4fec7b1928508568 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5a936d4fec7b5850244502 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5a936d4fec7a5722591158 = array(
    ...
    {
        $this->initializer5a936d4fec7b5850244502 && ($this->initializer5a936d4fec7b5850244502->__invoke($valueHolder5a936d4fec7b1928508568, $this, 'set_environment', array('env' => $env), $this->initializer5a936d4fec7b5850244502) || 1) && $this->valueHolder5a936d4fec7b1928508568 = $valueHolder5a936d4fec7b1928508568;

        return $this->valueHolder5a936d4fec7b1928508568->set_environment($env);
    }
    ...
    {
        $this->initializer5a936d4fec7b5850244502 && ($this->initializer5a936d4fec7b5850244502->__invoke($valueHolder5a936d4fec7b1928508568, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer5a936d4fec7b5850244502) || 1) && $this->valueHolder5a936d4fec7b1928508568 = $valueHolder5a936d4fec7b1928508568;

        return $this->valueHolder5a936d4fec7b1928508568->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer5a936d4fec7b5850244502 && ($this->initializer5a936d4fec7b5850244502->__invoke($valueHolder5a936d4fec7b1928508568, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer5a936d4fec7b5850244502) || 1) && $this->valueHolder5a936d4fec7b1928508568 = $valueHolder5a936d4fec7b1928508568;

        return $this->valueHolder5a936d4fec7b1928508568->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer5a936d4fec7b5850244502 = $initializer;
    }
    ...
    {
        $this->initializer5a936d4fec7b5850244502 && ($this->initializer5a936d4fec7b5850244502->__invoke($valueHolder5a936d4fec7b1928508568, $this, '__get', array('name' => $name), $this->initializer5a936d4fec7b5850244502) || 1) && $this->valueHolder5a936d4fec7b1928508568 = $valueHolder5a936d4fec7b1928508568;

        if (isset(self::$publicProperties5a936d4fec7a5722591158[$name])) {
            return $this->valueHolder5a936d4fec7b1928508568->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5a936d4fec7b1928508568;
    ...
    {
        $this->initializer5a936d4fec7b5850244502 && ($this->initializer5a936d4fec7b5850244502->__invoke($valueHolder5a936d4fec7b1928508568, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5a936d4fec7b5850244502) || 1) && $this->valueHolder5a936d4fec7b1928508568 = $valueHolder5a936d4fec7b1928508568;
    ...
    {
        $this->initializer5a936d4fec7b5850244502 && ($this->initializer5a936d4fec7b5850244502->__invoke($valueHolder5a936d4fec7b1928508568, $this, '__isset', array('name' => $name), $this->initializer5a936d4fec7b5850244502) || 1) && $this->valueHolder5a936d4fec7b1928508568 = $valueHolder5a936d4fec7b1928508568;
    ...
    {
        $this->initializer5a936d4fec7b5850244502 && ($this->initializer5a936d4fec7b5850244502->__invoke($valueHolder5a936d4fec7b1928508568, $this, '__unset', array('name' => $name), $this->initializer5a936d4fec7b5850244502) || 1) && $this->valueHolder5a936d4fec7b1928508568 = $valueHolder5a936d4fec7b1928508568;
    ...
    {
        $this->initializer5a936d4fec7b5850244502 && ($this->initializer5a936d4fec7b5850244502->__invoke($valueHolder5a936d4fec7b1928508568, $this, '__clone', array(), $this->initializer5a936d4fec7b5850244502) || 1) && $this->valueHolder5a936d4fec7b1928508568 = $valueHolder5a936d4fec7b1928508568;

        $this->valueHolder5a936d4fec7b1928508568 = clone $this->valueHolder5a936d4fec7b1928508568;
    }

    public function __sleep()
    {
        $this->initializer5a936d4fec7b5850244502 && ($this->initializer5a936d4fec7b5850244502->__invoke($valueHolder5a936d4fec7b1928508568, $this, '__sleep', array(), $this->initializer5a936d4fec7b5850244502) || 1) && $this->valueHolder5a936d4fec7b1928508568 = $valueHolder5a936d4fec7b1928508568;

        return array('valueHolder5a936d4fec7b1928508568');
    }
    ...
    {
        return $this->initializer5a936d4fec7b5850244502;
    }
    ...
    {
        return $this->initializer5a936d4fec7b5850244502 && ($this->initializer5a936d4fec7b5850244502->__invoke($valueHolder5a936d4fec7b1928508568, $this, 'initializeProxy', array(), $this->initializer5a936d4fec7b5850244502) || 1) && $this->valueHolder5a936d4fec7b1928508568 = $valueHolder5a936d4fec7b1928508568;
    }
    ...
    {
        return null !== $this->valueHolder5a936d4fec7b1928508568;
    }
    ...
    {
        return $this->valueHolder5a936d4fec7b1928508568;
    }
